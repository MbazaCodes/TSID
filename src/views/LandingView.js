      ...
      <div style="padding:16px 0 32px">
        ...
        <div style="
          ...
          ${[
            ...
            <div>
              <div style="font-size:11px;color:#6ee7b7;font-weight:700">${icon} ${label}</div>
              <div style="font-size:10px;color:rgba(255,255,255,.5)">${sub}</div>
            </div>`).join("")}
        </div>
      </div>
    ...
    <div class="rg-landing landing-role-grid">
      ...
      <a href="#/login/school" style="text-decoration:none">
        <div class="landing-role-card" style="
          ...
          <div style="font-weight:800;font-size:16px;color:#0f172a;margin-bottom:6px">Shule / School</div>
      ...
      <a href="#/login/gov" style="text-decoration:none">
        <div class="landing-role-card" style="
          ...
          <div style="font-weight:800;font-size:16px;color:#0f172a;margin-bottom:6px">Serikali / Gov</div>
          <div style="font-size:12.5px;color:#64748b;line-height:1.5;margin-bottom:16px">
      ...
      <a href="#/login/student" style="text-decoration:none">
        <div class="landing-role-card" style="
          ...
          <div style="width:56px;height:56px;border-radius:16px;margin:0 auto 14px;
            ...
            display:flex;align-items:center;justify-content:center;font-size:26px">🎓</div>
          <div style="font-weight:800;font-size:16px;color:#0f172a;margin-bottom:6px">Mwanafunzi / Student</div>
          <div style="font-size:12.5px;color:#64748b;line-height:1.5;margin-bottom:16px">
